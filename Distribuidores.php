...
<br>
      <form class="row g-4 container-fluid" id="frm" method="POST" action="DistArchivos/Insertar.php" onsubmit="return valdez()" enctype="multipart/form-data">
        ...
        <div class="col-sm-4">
          ...
          <input type="text" class="form-control" id="innom"  name="innom" maxlength="40" pattern="[A-Za-z nÑáéíóúÁÉÍÓÚ.'´_-,]{1,30}" required placeholder="Ingresa el nombre">
        </div>

        <div class="col-sm-4">
          <label for="inrep" class="form-label">Representante</label>
          <input type="text" class="form-control" id="inrep"  name="inrep" maxlength="40" pattern="[A-Za-z nÑáéíóúÁÉÍÓÚ.'´_-,]{1,30}" required placeholder="Nombre del representante">
        </div>

        <div class="col-sm-4">
          <label for="indom" class="form-label">Domicilio</label>
          <input type="text" class="form-control" id="indom"  name="indom" maxlength="30" required placeholder="Ingresa el domicilio">
        </div>

        <div class="col-4">
            <label for="incp" class="form-label">Código Postal</label>
            <input type="text" class="form-control" id="incp" maxlength="5" name="incp" pattern="[0-9]{5}" required placeholder="P.ejem. 49000">
        </div>

        <div class="col-4">
          <label for="inciu" class="form-label">Ciudad</label>
          <input type="text" class="form-control" id="inciu"  name="inciu" maxlength="30" pattern="[A-Za-z nÑáéíóúÁÉÍÓÚ.'´_-,]{1,30}" required placeholder="Ingresa la ciudad">
        </div>

        <div class="col-4">
          <label for="inmuni" class="form-label">Municipio</label>
          <input type="text" class="form-control" id="inmuni"  name="inmuni" maxlength="40" pattern="[A-Za-z nÑáéíóúÁÉÍÓÚ.'´_-,]{1,30}" required placeholder="Ingresa el municipio">
        </div>
        ...
        <div class="col-4">
            ...
            <input type="text" class="form-control" id="intel" maxlength="10" name="intel" pattern="[0-9]{10}" required placeholder="5521234567">
        </div>

        <div class="col-sm-4">
          <label for="incorr" class="form-label">Correo</label>
          <input type="text" class="form-control" id="incorr"  name="incorr" maxlength="30" pattern="[A-Za-z ñÑáéíóúÁÉÍÓÚ#@0-_9.,-]{1,30}" required placeholder="ejemplo@gmail.com">
        </div>
