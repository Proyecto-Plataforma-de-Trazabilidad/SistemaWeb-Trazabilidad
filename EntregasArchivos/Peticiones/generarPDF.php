...
<head>
    ...
    <style>
        ...
        .bgimage {
            background-image: url(http://localhost/SistemaWeb-Trazabilidad/Logos/AMOCALI-fondo.png) no-repeat center center fixed;
...
<body>
    <!-- <div class="bgimage"> -->
        ...
        <?php
        // $comando = mysqli_query($enlace, "SELECT * FROM productores WHERE IdProductor = '" . $_POST['idProduc'] . "'");
